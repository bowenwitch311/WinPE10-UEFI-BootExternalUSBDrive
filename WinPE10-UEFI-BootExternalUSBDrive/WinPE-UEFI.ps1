...
Make-Directory -folderPath $WinPE_BuildFolder # créer un nouveau dossier $WinPE_BuildFolder
Make-Directory -folderPath $WinPE_MountFolder # créer un nouveau dossier $WinPE_MountFolder
